(() => {
    ...
    function initSliders() {
        if (document.querySelector(".about__slider.swiper")) new core(".about__slider.swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            speed: 800,
            navigation: {
                prevEl: ".navigation-about__arrow.swiper-button-prev",
                nextEl: ".navigation-about__arrow.swiper-button-next"
            },
            on: {}
        });
    }
